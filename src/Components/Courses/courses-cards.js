      ...
      <div className='bg-white '>
        ...
        {exploreCourses.map((val,index)=>(
          ...
          <div className='rate'>
                  ...
                  <p>₹ {val.price}</p>
                  <Link to={`${val.title}`}> <button className='border rounded-lg border-gray-600 p-2 hover:-translate-y-1 hover:scale-100 duration-200 hover:bg-green-500 hover:text-white' >
                    {val.button}
                    </button></Link>
                  </div>
